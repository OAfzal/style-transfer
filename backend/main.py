...
def evaluate():
    print("In Eval")    
    content_image = utils.tensor_load_rgbimage("images/content/venice-boat.jpg", size=1024, keep_asp=True)
    content_image = content_image.unsqueeze(0)
    style = utils.tensor_load_rgbimage("images/21styles/candy.jpg", size=1024)
    ...
    utils.tensor_save_bgrimage(output.data[0], "", 0)
